...
router.get('/:id', validateObjectId('id'), authenticate, requireSubscription, getAssignmentById);

// @route   GET /api/assignments/:id/stats
// @desc    Get assignment statistics
// @access  Private (Instructor/Admin only)
router.get('/:id/stats', validateObjectId('id'), authenticate, getAssignmentStats);

// @route   POST /api/assignments
// @desc    Create new assignment
// @access  Private (Instructor/Admin only)
router.post('/', authenticate, authorize('teacher', 'admin'), validateAssignmentCreation, createAssignment);

// @route   PUT /api/assignments/:id
// @desc    Update assignment
// @access  Private (Instructor/Admin only)
router.put('/:id', validateObjectId('id'), authenticate, updateAssignment);
...
// @access  Private (Instructor/Admin only)
router.delete('/:id', validateObjectId('id'), authenticate, deleteAssignment);
